...
build {
  ...
  # The provisioning extends the one for GCP by running the waagent at the end. This
  # cleans the VM from users and SSH keys so that the image can safely be used in a new
