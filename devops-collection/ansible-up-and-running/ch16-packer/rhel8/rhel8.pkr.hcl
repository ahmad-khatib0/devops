# When the Anaconda installer finishes, the virtual machine reboots and Packer starts
# provisioning by running the scripts and eventually packer-playbook.yml with the
# provisioner "ansible". This runs from your machine.
