...
# use the aws_eks_node_group resource to create the managed node group itself
# This code configures the managed node group to use the control plane and IAM role you just created: 
