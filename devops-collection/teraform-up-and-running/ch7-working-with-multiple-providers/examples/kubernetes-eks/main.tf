...
module "simple_webapp" {
  ...
  # Only deploy the app after the cluster has been deployed: depends_on parameter to ensure that 
  # Terraform only tries to deploy the Docker image after the EKS cluster has been deployed.
