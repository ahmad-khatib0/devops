...
resource "aws_autoscaling_group" "example" {
  ...
  lifecycle {
    postcondition {
      ...
      # here we check that the ASG was deployed across more than one Availability Zone (AZ)
      # NOTE: You can use this special syntax solely in postcondition, connection, and provisioner blocks 
      # to refer to an output ATTRIBUTE of the surrounding resource. If you tried to use the standard
