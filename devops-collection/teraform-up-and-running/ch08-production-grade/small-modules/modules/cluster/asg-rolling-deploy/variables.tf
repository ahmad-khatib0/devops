...
# subnet_ids, tells the asg-rolling-deploy module what subnets to deploy into y exposing 
# the subnet_ids variable, you allow this module to be used with any VPC or subnets
variable "subnet_ids" {
