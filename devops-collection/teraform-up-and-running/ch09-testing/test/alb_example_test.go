...
func TestAlbExamplePlan(t *testing.T) {
	...
	// you could check that the plan output includes the aws_lb resource at address module.alb.aws_lb.example
	// and that the name attribute of this resource is set to the expected value, as follows:
